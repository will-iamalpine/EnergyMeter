...
const int TIME_BETWEEN_READINGS=  100;                             // Time between readings (ms)
...
const int timeout=                100;                               // emonLib timeout
...
float Vrms;
float Irms;
} DataPayload;                                                    // create JeeLabs RF packet structure for ML data
DataPayload emonData;
//-------------------------------------------------------------------------------------------------------------------------------------------
//-------------------------------------------------------------------------------------------------------------------------------------------
